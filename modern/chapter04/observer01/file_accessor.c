...
static void defalut_file_error_handler(FileErrorObserver *pThis, FileAccessorContext *pFileCtx);

FileErrorObserver defalut_file_error_observer = {
  &defalut_file_error_handler
};
